...
class MAPPO:
    ...
    def __init__(self, env, state_dim, action_dim,
        ...
        if self.optimizer_type == "adam":
            self.actor_optimizer = Adam( params=self.actor.parameters(), lr=self.actor_lr)
            self.critic_optimizer = Adam(params=self.critic.parameters(), lr=self.critic_lr)
        elif self.optimizer_type == "rmsprop":
            self.actor_optimizer = RMSprop(params=self.actor.parameters(), lr=self.actor_lr)
            self.critic_optimizer = RMSprop(params=self.critic.parameters(), lr=self.critic_lr)
            # self.actor_optimizer = optim.SGD(self.actor.parameters(), lr=self.actor_lr)
    ...
    def train(self):
            ...
            # print(self.actor.parameters())
                for param in self.actor.parameters():
                    if param.grad is not None:
                        ...
                        actor_gradients0.append(param.grad)
                ...
                for param in self.actor.parameters():
                    if param.grad is not None:
                        ...
                        actor_gradients1.append(param.grad)
                ...
                for param in self.actor.parameters():
                    if param.grad is not None:
                        ...
                        actor_gradients2.append(param.grad)
                ...
                for param in self.actor.parameters():
                    if param.grad is not None:
                        ...
                        actor_gradients3.append(param.grad)
                        # actor_gradients.append(agent_id)
                        # print(param.grad.data,agent_id,"梯度")
                    else:
            ...
            if agent_id ==0:
                for param in self.critic.parameters():
                    if param.grad is not None:
                        ...
                        critic_gradients0.append(param.grad)
                    else:
                ...
                for param in self.critic.parameters():
                    if param.grad is not None:
                        ...
                        critic_gradients1.append(param.grad)
                ...
                for param in self.critic.parameters():
                    if param.grad is not None:
                        ...
                        critic_gradients2.append(param.grad)
                ...
                for param in self.critic.parameters():
                    if param.grad is not None:
                        ...
                        critic_gradients3.append(param.grad)
                        # critic_gradients.append(agent_id)
                        # print(param.grad.data,agent_id,"梯度")
                    else:
        ...
        if self.n_agents == 3:
            for i in range(6):
                print(actor_gradients0[i],actor_gradients1[i],actor_gradients2[i])
                print("相加",actor_gradients0[i]+actor_gradients1[1])
