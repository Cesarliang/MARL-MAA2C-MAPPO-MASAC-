...
class MAPPO:
    ...
    def train(self):
        ...
        for agent_id in range(self.n_agents):
            ...
            # print(self.actor.parameters())
                for param in self.actor.parameters():
                    if param.grad is not None:
                        ...
                        actor_gradients0.append(agent_id)
                ...
                for param in self.actor.parameters():
                    if param.grad is not None:
                        ...
                        actor_gradients1.append(agent_id)
                        # print(param.grad.data,agent_id,"梯度")
                    else:
            ...
            actor_avg_gradients = []
        print(actor_gradients0,actor_gradients1)
        for i in range(len(actor_avg_gradients)):
            if actor_avg_gradients[i] is not None:
                actor_avg_gradients[i] /= self.n_agents
