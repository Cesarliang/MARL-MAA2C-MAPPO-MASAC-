...
class MAPPO:
    ...
    def __init__(self, env, state_dim, action_dim,
        ...
        if self.optimizer_type == "adam":
            self.actor_optimizer = Adam(parameters = self.actor.parameters(), lr=self.actor_lr)
            self.critic_optimizer = Adam(parameters =self.critic.parameters(), lr=self.critic_lr)
        elif self.optimizer_type == "rmsprop":
            self.actor_optimizer = RMSprop(parameters =self.actor.parameters(), lr=self.actor_lr)
            self.critic_optimizer = RMSprop(parameters =self.critic.parameters(), lr=self.critic_lr)
