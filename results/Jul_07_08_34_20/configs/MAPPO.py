            ...
            # print(self.actor.parameters())
                for param in self.actor.parameters():
                    if param.grad is not None:
                        print(param.grad,"lloooo")
                        actor_gradients0.append(param.grad.data)
                ...
                for param in self.actor.parameters():
                    if param.grad is not None:
                        ...
                        actor_gradients1.append(param.grad.data)
                ...
                for param in self.actor.parameters():
                    if param.grad is not None:
                        ...
                        actor_gradients2.append(param.grad.data)
                ...
                for param in self.actor.parameters():
                    if param.grad is not None:
                        ...
                        actor_gradients3.append(param.grad.data)
                        # actor_gradients.append(agent_id)
                        # print(param.grad.data,agent_id,"梯度")
                    else:
